...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_rap100_atrav655,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav655 FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_atr020_d FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF zr_rap100_atrav655 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF zr_rap100_atrav655 IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
* Deduct the specified discount from the booking fee (BookingFee)
**************************************************************************
    DATA travels_for_update TYPE TABLE FOR UPDATE zr_rap100_atrav655.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
       travels       TYPE TABLE FOR CREATE zr_rap100_atrav655\\travel.
